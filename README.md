...
## 1. 프로젝트 개요
공공데이터를 활용하여, 지역 음식점 목록을 자동으로 업데이트 하고 이를 활용하는 위치기반 맛집 서비스<br>
사용자의 위치에 맞게 맛집 및 메뉴를 추천하여 더 나은 음식 경험을 제공하고, 음식을 좋아하는 사람들 간의 소통과 공유를 촉진한다.

### ✨ 사용자 주요 기능
- 회원가입 및 사용자 위치 기반 설정 기능
- 내 위치 기반 맛집 추천 (1km 이내), 거리순·평점순 정렬 옵션 제공
- 맛집 상세 정보 및 사용자 평점 정보 제공
- 점심 추천 서비스 (선택 동의자 대상, Discord Webhook 전송)
...
✔️ 요구사항 : [위치 기반 맛집 추천 서비스](https://bow-hair-db3.notion.site/f2c5e47f67254726ba0ef8d894f7e8b9#f62425d8700b485da11338e3b0eb06c4)
...
| 안소나 | 시군구 목록 조회 API, 맛집 평가 생성 API, 시군구 조회 캐싱|         |
...
| ~ 24.09.04 (수)| 추가 요구사항 개발 |
| 24.09.04 (수) | 최종 README.md 작성 및 추가 요구사항 점검|
